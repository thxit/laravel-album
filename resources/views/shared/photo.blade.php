<div class="col-md-3 col-sm-4 photo item">
	<div class="panel panel-default">
		<div class="panel-body">
			...
			@endif
			<!-- Edit photos: pop-up box button -->
			<span class="glyphicon glyphicon-cog photo-conf" data-toggle="modal" data-target="#editPhoto{{ $photo->id }}"></span>
		</div>
	</div>
</div>

<!-- Edit photo: pop-up box buton-->
<div class="modal fade" id="editPhoto{{ $photo->id }}" tabindex="-1" role="dialog" aria-lobelledby="myModalLabel">
